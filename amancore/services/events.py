...
EVENT_TYPES = {
    ...
    "optout.recorded", "optout.reply_blocked",
    "handover.mode_changed", "handover.channel_ai_toggled",
    ...
    "offer.generated", "offer.recommended", "price.calculated", "pricing.warning",
    "scope.analyzed", "scope.reduced", "price.moved",
    "pricing.approval_requested", "pricing.approved", "pricing.rejected", "pricing.snapshot_created",
    "quote.approval_pending", "quote.snapshot_created",
    "proposal.created", "proposal.review_requested", "proposal.approved", "proposal.rejected", "proposal.expired",
    "negotiation.started",
    ...
    "care_plan.created",
    "intent.routed",
    "support.case.created", "support.case.updated", "support.case.escalated",
    "support.case.resolved", "support.case.closed", "support.priority.changed",
    "support.handoff_requested", "support.sla_unknown",
    "followup.due", "followup.planned", "followup.cancelled", "followup.sent",
    "insight.created", "insight.updated", "insight.expired", "insight.superseded",
    "recommendation.created", "recommendation.decision",
    "decision.recorded", "brain_change.proposed",
    "alert.raised", "alert.delivered",
